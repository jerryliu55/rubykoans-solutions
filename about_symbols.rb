...
class AboutSymbols < Neo::Koan
  ...
  #
  # => using the symbol makes it always true, since there is only 1 of each symbol
  ...
  #
  # => they take up a lot of memory that cannot be freed since symbols are immutable
end
