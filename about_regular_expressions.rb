...
class AboutRegularExpressions < Neo::Koan
  ...
  # Why?
  #
  # => they take the first match that they find in the string
  ...
  #
  # => alternation can be used as character classes but character classes cannot be used as alternation every time
  # => character classes work on individual characters
